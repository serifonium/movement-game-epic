...
import {watcherTexture, fireTexture} from "./image.js"
import {Hitbox, NoCollisionHitbox, CombatText, StyleText} from "./classes.js"
import {ctx, objects, checkObjsOverlap} from "./startup.js"
...
class Enemy {
    constructor(pos, scale){
        ...
        this.remove = () => {
            particleHandler.burstParticles(this.pos, 120, 100, {
                angleRange:360,
...
class Husk extends Enemy {
    constructor(pos) {
        ...
        this.update = (e) => {
            ...
            let u = true
            for(let obj of objects) { if(overlapping(this.pos.x, this.pos.y+1, this.scale.x, this.scale.y, obj.pos.x, obj.pos.y, obj.scale.x, obj.scale.y)
            ...
            u = true
            for(let obj of objects) {if(overlapping(this.pos.x, this.pos.y+this.vel.y, this.scale.x, this.scale.y, obj.pos.x, obj.pos.y, obj.scale.x, obj.scale.y)
...
export {Enemy, Drone, Virtue, Idol, Watcher, Bullet}